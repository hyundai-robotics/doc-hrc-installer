...
* [2. 준비](2-preparation/README.md)
    ...
    * [2.2 설정 파일 작성](2-preparation/2-config.md)
* [3. 실행](3-execution/README.md)
    * [3.1 인스톨러 실행](3-execution/1-run.md)
    * [3.2 실행 로그 확인](3-execution/2-result.md)
* [4. 문제 해결 및 에러 코드](4-troubleshooting/README.md)
